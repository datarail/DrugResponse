...
def load_well_metadata(name = 'meta', folder=None, 
    ...
    if folder is None:
        ...
        folder = "/mnt/c/Users/NC168/git/LINCS_combos/data/metadata/"
...
### gets live/dead counts for whole 
...
def get_counts_timecourse(out_file="lincs_combos_timecourse_new_counts_2025_01_14", out_dir = "results", 
                   n_wells=None, n_plates=None):
    barcodes = ["210406_combo_63", "210406_combo_64", "210406_combo_65", "210406_combo_66", 
"210406_combo_67", "210406_combo_68"] ### timecourse barcodes not yet regated
    ## other timecourse barcodes already regated: ["210406_combo_69", "210406_combo_70", "210406_combo_71", "210406_combo_72", "210406_combo_73", "210406_combo_74", "210406_combo_75", "210406_combo_76", "210406_combo_77"]
    out_csv = os.path.join(out_dir, out_file + ".csv")
    out_parquet = os.path.join(out_dir, out_file + ".parquet")
    if os.path.exists(out_csv):
        df_old = pd.read_csv(out_csv)
